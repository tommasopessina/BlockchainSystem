#This script get the energy counter
#client
...
print("Total common energy used:",(mContract.functions.getCommonEnergyUsed().call())/100)
print("Total energy used:",(mContract.functions.showTotalEnergyUsed().call())/100)
print("Total energy produced:",(mContract.functions.showEnergyProduced().call())/100)
