#Script for removing the given role to a given client wallet address
...
contract_data = mContract.functions.removeRole(clientAddress,role).buildTransaction({'from': account,
                                                          'gas': 1728712,
...
print("Does the address still have the given role?",mContract.functions.hasRole(clientAddress,role).call())
